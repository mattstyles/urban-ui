...
// These become static, they do not reference other variables
// export const interactive = defineVars({
//   hover: `oklch(from ${tokens.background} calc(l * 0.95) c h)`,
//   active: `oklch(from ${tokens.background} calc(l * 0.8) c h)`,
// })
