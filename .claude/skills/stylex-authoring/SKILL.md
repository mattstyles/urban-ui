...
description: How to write StyleX styles — stylex.create/props, conditional styles, pseudo-classes, media queries, variables/themes (defineVars/createTheme), typed style props, and antipatterns to avoid. Use whenever writing or reviewing component styling in this project (all styling here is StyleX, no Tailwind/CSS files).
---
